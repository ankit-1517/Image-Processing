...
class CollectData:
	...
	def statistics(self):
		...
		for threshold in tqdm(range(0,255)):
			...
			temp_FN=0.0
			temp_TN=0.0
			print(len(self.groundtruth), len(self.probgraph))
		...
		# print("TP: " + str(self.TP) + "FP: " + str(self.FP) + "TN: " + str(self.TN) + "FN: " + str(self.FN))
...
def drawCurve(gtlist,problist,modelName,dataset,savepath='/home/ankit/Desktop/Acad/Sem/Sem6/ELL715/Assn/10/Retina-VesselNet/results/'):
	"""
